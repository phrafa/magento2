<?php
namespace Dotdigitalgroup\Email\Model\ResourceModel\Abandoned\Collection;

/**
 * Interceptor class for @see \Dotdigitalgroup\Email\Model\ResourceModel\Abandoned\Collection
 */
class Interceptor extends \Dotdigitalgroup\Email\Model\ResourceModel\Abandoned\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Dotdigitalgroup\Email\Model\Newsletter\SubscriberFilterer $subscriberFilterer, \Magento\Framework\Data\Collection\EntityFactoryInterface $entityFactory, \Psr\Log\LoggerInterface $logger, \Magento\Framework\Data\Collection\Db\FetchStrategyInterface $fetchStrategy, \Magento\Framework\Event\ManagerInterface $eventManager, ?\Magento\Framework\DB\Adapter\AdapterInterface $connection = null, ?\Magento\Framework\Model\ResourceModel\Db\AbstractDb $resource = null)
    {
        $this->___init();
        parent::__construct($subscriberFilterer, $entityFactory, $logger, $fetchStrategy, $eventManager, $connection, $resource);
    }
