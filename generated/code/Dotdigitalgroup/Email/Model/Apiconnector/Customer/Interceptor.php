...
class Interceptor extends \Dotdigitalgroup\Email\Model\Apiconnector\Customer implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function setContactData($customer)
    {
        ...
        if (!$pluginInfo) {
            return parent::setContactData($customer);
        } else {
            return $this->___callPlugins('setContactData', func_get_args(), $pluginInfo);
        }
    }
}
