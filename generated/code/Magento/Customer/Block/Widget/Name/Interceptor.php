...
class Interceptor extends \Magento\Customer\Block\Widget\Name implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getPrefixOptions()
    {
        ...
        if (!$pluginInfo) {
            return parent::getPrefixOptions();
        } else {
            return $this->___callPlugins('getPrefixOptions', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getSuffixOptions()
    {
        ...
        if (!$pluginInfo) {
            return parent::getSuffixOptions();
        } else {
            return $this->___callPlugins('getSuffixOptions', func_get_args(), $pluginInfo);
        }
    }
}
